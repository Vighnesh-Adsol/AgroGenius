...
const Home = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <div>
      ...
      <button className="btn btn-primary mr-4" onClick={()=> navigate("/chat")}>Get Expert Opinion</button>

      <button className="btn btn-primary" onClick={()=> navigate("/image-detection")}>Get AI Opinion</button>
    </div>
  </div>
</div>
